<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AltaCobertura.aspx.cs" Inherits="WebApplication1.AltaCobertura" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row  justify-content-center" style="margin-top:70px; margin-bottom:50px; margin-left:150px">
        <div class="col-md-3" >
            ...
            <asp:TextBox ID="txtCobertura" CssClass="form-control rounded-pill" runat="server" />
            <div style="font-size:13px">
                     <asp:RequiredFieldValidator runat="server" ErrorMessage="*Debe completar el campo" ControlToValidate="txtCobertura" ForeColor="#CC0000" Display="Dynamic"></asp:RequiredFieldValidator>
                     <asp:RegularExpressionValidator ErrorMessage="*Ingrese un ID válido" ControlToValidate="txtCobertura" Runat="server" Display="Dynamic" EnableClientScript="true" ValidationExpression="\d+" ForeColor="#CC0000"></asp:RegularExpressionValidator>  
