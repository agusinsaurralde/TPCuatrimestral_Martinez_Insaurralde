...
<br />
    ...
    <div class="d-flex justify-content-end">
         <div class="row" style="margin-bottom: 40px; margin-top:20px">
            ...
            <!-- modal -->
        <asp:Button  style="display:none" runat="server" ID="btnModificarEmpleadoF" />
   <ajaxToolkit:ModalPopupExtender ID="btnRevisaSiModifica_Modal" CancelControlID="exitCheck" Enabled="true" runat="server" BackgroundCssClass="fondo" BehaviorID="btnRevisaSiAgrega_Modal" TargetControlID="btnModificarEmpleadoF" PopupControlID="PanelCheck">
    ...
    <asp:Panel ID="PanelCheck" Width="300px" BackColor="White" runat="server">
        ...
        <div class="modal-footer">
            <asp:Button ID="btnCerrarModalModiciarEmpleado" Text="CERRAR" OnClick="btnCerrarModalModiciarEmpleado_Click" class="btn btn-outline-secondary rounded-pill" BorderStyle="None" Font-Size="Small" Font-Bold="true" data-bs-dismiss="modal" runat="server" />
        </div>
    </asp:Panel>
</asp:Content>
